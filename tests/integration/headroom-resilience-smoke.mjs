...
if (!process.argv.includes("--child")) {
  ...
  const env = ["HEADROOM_COMPRESS_ALLOW_REMOTE=1", "HEADROOM_SKIP_UPSTREAM_CHECK=1", "HEADROOM_DISABLE_KOMPRESS=1",
    ...
    "HEADROOM_MODEL_ROUTER_ENABLED=0", "HEADROOM_COMPRESSION_MAX_WORKERS=1", "HEADROOM_COMPRESSION_TIMEOUT_SECONDS=8",
    "HEADROOM_OFFLINE=1", "HF_HUB_OFFLINE=1", "TRANSFORMERS_OFFLINE=1",
